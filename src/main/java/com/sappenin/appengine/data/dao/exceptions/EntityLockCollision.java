...
/**
 * Thrown if an EntityLock is violated (Generally indicates that a particular
 * field-value has already been locked). This is mapped in
 * {@link DefaultRestErrorResolver} as an Http CONFLICT.
 * 
 * @author sappenin
 */
