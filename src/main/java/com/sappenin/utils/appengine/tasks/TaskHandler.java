...
/**
 * Interface for TaskHandler logic for Google Appengine.
 *
 * @author David Fuelling
 */
public interface TaskHandler
{
	public static final String SERVLET_PATH__TASKS = "/tasks";

	/**
	 * Handles a particular task for the TaskQueue system on Google Appengine.
	 */
