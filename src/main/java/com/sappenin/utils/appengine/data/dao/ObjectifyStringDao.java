...
public interface ObjectifyStringDao<T extends AbstractEntity> extends ObjectifyDao<T>
{
	 ...
	 * entities, this function will first check the Datastore to see if an entity exists. If it does, then a {@link
	 * DuplicateEntityException} will be thrown. If no entity with the same Key exists in the datastore, then this
	 * operation will succeed in the same fashion as {@link #save(AbstractEntity)}.
	 *
