...
public class ObjectifyEntityLockHelper implements Serializable
{
	 ...
	 * particular entity. Must be called inside of an existing Objectify transaction.<br/>
	 * <br/>
	 * This function is performed inside of an existing transaction so that if a collision is detected, no parent caller
	 * will succeed accidentally. Additionally, if an exception is thrown, then the caller can rollback the entire
	 * transaction and no lock will be stored.
	 * 
	 * @param ofyTrans
	 * @param lock
	 * @return
